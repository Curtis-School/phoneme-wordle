...
/**
 * Every icon used across the app, in one place so a shape isn't redefined per component.
 * Each accepts standard SVG props, spread after its own defaults, so a caller can
 * override size, stroke width, className, etc. where its usage differs from the default.
 */
